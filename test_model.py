...
with tf.compat.v1.Session(config=config) as sess:
    ...
    if arch == "pcan":
        enhanced = PCAN(x_, instance_norm=inst_norm, instance_norm_level_1=False, num_maps_base=num_maps_base)
    ...
    if test_image:
        test_dir_full = dataset_dir + "/test/"
        ...
        for photo in test_photos:
            ...
            imageio.imwrite(result_dir + photo_name + ".png", enhanced_image)            
